  ...
  return [
    {
      ...
      templateId: d?.id,
      templateName: d?.name,
      notifyMethodIds: ['nm-mail-report', 'nm-ding-ops'],
      recipientsMail: 'zhangsan@example.com; lisi@example.com',
      recipientsDing: '@所有人',
      recipientsWework: '',
      channelEmail: true,
      channelDing: true,
    ...
    },
    {
      ...
      templateName: w?.name,
      notifyMethodIds: ['nm-mail-report', 'nm-ding-ops'],
      recipientsMail: 'risk-team@example.com',
      recipientsDing: '',
      recipientsWework: '',
      channelEmail: true,
      channelDing: true,
    ...
    },
    {
      ...
      templateId: m?.id,
      templateName: m?.name,
      notifyMethodIds: ['nm-mail-report'],
      recipientsMail: 'leader@example.com',
      recipientsDing: '',
      recipientsWework: '',
      channelEmail: true,
      channelDing: false,
